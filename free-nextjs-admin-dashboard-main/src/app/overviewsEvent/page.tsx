...
export default function Example() {
  ...
  function setSelectedColor(value: any): void {
    throw new Error("Function not implemented.");
  }

  function setSelectedSize(value: any): void {
    throw new Error("Function not implemented.");
  }
            ...
            <li className="pt-1.5 font-dm text-sm font-medium text-slate-700">
              ...
              <div className="ml-auto flex items-center">
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                  <a href="/auth/signin" className="text-sm font-medium text-gray-700 hover:text-gray-800">Sign in</a>
                  <span aria-hidden="true" className="h-6 w-px bg-gray-200" />
                  <a href="/auth/signup" className="text-sm font-medium text-gray-700 hover:text-gray-800">Create account</a>
                </div>
