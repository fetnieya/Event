 ...
 <div className="w-full max-w-lg mx-auto p-8">
      <div className="bg-white rounded-lg shadow-lg p-6">
        ...
        <form>
          ...
          <div className="mt-8">
          <a href="/cashPay" role="button">
           <button className="bg-indigo-50 text-indigo-600 rounded-full cursor-pointer font-semibold text-center shadow-xs transition-all duration-500 py-4 px-6 text-base hover:bg-indigo-100 w-100 mt-6">
              Validate payment 
             </button>
          </a>
          </div>
