  ...
  const handleSubmit = async (e:any) => {
      ...
      try {
          ...
          if (response.status === 201) {
            localStorage.setItem('token', JSON.stringify(response.data.token)); // Assuming response.data contains the token
            
            // Check the role in the response data and redirect accordingly
            const userRole = response.data.role; // Assuming role is sent in the response

            if (userRole === 'admin') {
                router.push('/'); // Redirect to admin page
            } else if (userRole === 'user') {
                router.push('/forms/form-layout'); // Redirect to participant forms page
            } else {
  ...
  return (
      ...
      <div className="flex flex-wrap items-center">
        <div className="hidden w-full xl:block xl:w-1/2">
          <div className="px-26 py-75 text-center">
