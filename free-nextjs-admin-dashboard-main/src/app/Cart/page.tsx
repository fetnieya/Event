  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 1-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 0 0-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 0 1 3.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 0 0-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 0 0-7.5 0" />
          ...
          <div className="mt-4">
            <input
              ...
              className="border rounded-md py-1 px-3 w-3/2 mb-5"
            />
            <button className="bg-indigo-50 text-indigo-600 rounded-full cursor-pointer font-semibold text-center shadow-xs transition-all duration-500 py-2 px-4 text-sm hover:bg-indigo-100">Apply </button>
          </div>
        </div>
        <a href="/forms/form-layout" className="flex font-semibold text-indigo-600 text-sm mt-10">
      ...
      <div className="md:w-1/4">
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <a href="/Checkout" role="button">
           <button className="bg-indigo-50 text-indigo-600 rounded-full cursor-pointer font-semibold text-center shadow-xs transition-all duration-500 py-4 px-6 text-base hover:bg-indigo-100 w-80 mt-6">
              Checkout
             </button>
          </a>
